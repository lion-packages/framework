...
class UsersControllerTest extends Test
{
    ...
    {
        $response = fetch(Http::HTTP_POST, self::API_URL, [
            'headers' => [
    ...
    {
        $users = json_decode(
            fetch(Http::HTTP_GET, self::API_URL, [
                'headers' => [
                    'Authorization' => $this->getAuthorization()
                ]
            ])
    ...
    public function testReadUsersWithoutData(): void
    {
        ...
        $users = fetch(Http::HTTP_GET, self::API_URL, [
            'headers' => [
                'Authorization' => $this->getAuthorization()
            ]
        ])
    ...
    public function testReadUsersById(): void
    {
        ...
        $user = json_decode(
            fetch(Http::HTTP_GET, (self::API_URL . '/' . $firstUser->idusers), [
                'headers' => [
                    'Authorization' => $this->getAuthorization()
                ]
            ])
    ...
    public function testReadUsersByIdWithoutData(): void
    {
        ...
        $users = fetch(Http::HTTP_GET, self::API_URL . '/1', [
            'headers' => [
                'Authorization' => $this->getAuthorization()
            ]
        ])
    ...
    public function testUpdateUsers(): void
    {
        ...
        $response = fetch(Http::HTTP_PUT, self::API_URL . '/' . $firstUser->idusers, [
    ...
    public function testDeleteUsers(): void
    {
        ...
        $response = fetch(Http::HTTP_DELETE, self::API_URL . '/' . $firstUser->idusers, [
            'headers' => [
                'Authorization' => $token
            ]
        ])
